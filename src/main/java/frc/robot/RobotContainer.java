...
public class RobotContainer {
    ...
    private void configureBindings() {
        ...
        keyboardController.getRightTrigger()
                .onTrue(new DriveToPose(drivebase, FieldConstants.ScorePositionRight, driveDirectAngle));

        keyboardController.getUpTrigger()
                .onTrue(new DriveToPose(drivebase, FieldConstants.ScorePositionCenter, driveDirectAngle));
