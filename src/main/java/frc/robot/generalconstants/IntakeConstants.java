...
public final class IntakeConstants {
    public final class Pid {
        ...
        public static final double KD = 0.01; // 0.01
    ...
    public final class Setpoints{
        public static final double POSITION_UP = 1.5;
        public static final double POSITION_DOWN = 22;
    }

    public final class Speeds{
        public static final double SPEED_INTAKE = 1;
        public static final double SPEED_OUTAKE = -0.625;
    }
}